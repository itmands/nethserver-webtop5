    ...
    <form class="form-horizontal">
      <div class="form-group">
        <div class="col-xs-12 col-sm-3 col-md-4">
          ...
          >
            <option selected>/var/log/webtop/webtop.log</option>
            <option>/var/lib/tomcats/webtop/logs/catalina.log</option>
            <option>/var/log/z-push/server.log</option>
            <option>/var/log/z-push/server_error.log</option>
            <option>/var/log/z-push/z-push.log</option>
            <option>/var/log/z-push/z-push_error.log</option>
            <option>/var/log/webtop-dav/dav-server.log</option>
          </select>
        </div>
...
export default {
  ...
  data() {
    return {
      view: {
        path: "/var/log/webtop/webtop.log",
        logsLoaded: false,
        logsContent: "",
        follow: false,
        filter: "",
